...
var linuxSyscallChecks = map[string]func(*checkContext, *prog.Syscall) string{
	...
	"syz_addqdisc_root_htb":	 alwaysSupported,
	"syz_addqdisc_root_prio":	 alwaysSupported,
	"syz_addqdisc_root_qfq":	 alwaysSupported,

	"syz_addqdisc_cake":  		 alwaysSupported,
	"syz_addqdisc_cbs":  		 alwaysSupported,
	"syz_addqdisc_netem": 		 alwaysSupported,
	...
	"syz_changeqdisc_cake":  	 alwaysSupported,
	"syz_changeqdisc_cbs":   	 alwaysSupported,
	"syz_changeqdisc_netem": 	 alwaysSupported,
	"syz_changeqdisc_red":   	 alwaysSupported,
	"syz_changeqdisc_sfb":   	 alwaysSupported,
	"syz_changeqdisc_tbf":   	 alwaysSupported,
	"syz_changeqdisc_ets":   	 alwaysSupported,
	"syz_changeqdisc_prio":  	 alwaysSupported,

	"syz_changeclass_drr":  	 alwaysSupported,
	"syz_changeclass_hfsc": 	 alwaysSupported,
	"syz_changeclass_htb": 		 alwaysSupported,
