...
MACRO_SYZ_ADDQDISC_ROOT(Q_CBS,   cbs)
MACRO_SYZ_ADDQDISC_ROOT(Q_NETEM, netem)
MACRO_SYZ_ADDQDISC_ROOT(Q_RED,   red)
MACRO_SYZ_ADDQDISC_ROOT(Q_SFB,   sfb)
MACRO_SYZ_ADDQDISC_ROOT(Q_TBF,   tbf)
